...
/// <summary>
/// Implements the FORECAST.ETS.CONFINT function.
/// FORECAST.ETS.CONFINT(target_date, values, timeline, [confidence_level], [seasonality], [data_completion], [aggregation])
/// Returns the confidence interval for the forecast value at target_date.
/// </summary>
public sealed class ForecastEtsConfintFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly ForecastEtsConfintFunction Instance = new();

    private ForecastEtsConfintFunction()
    {
    }
    ...
    public CellValue Execute(CellContext context, CellValue[] args)
    {
        ...
        try
        {
            ...
            double confidenceInterval = ForecastHelper.CalculateConfidenceInterval(
                etsResult,
                stepsAhead,
                confidenceLevel);
