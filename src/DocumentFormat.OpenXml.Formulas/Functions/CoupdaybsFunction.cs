...
/// <summary>
/// Implements the COUPDAYBS function.
...
/// </summary>
public sealed class CoupdaybsFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly CoupdaybsFunction Instance = new();
    ...
    public CellValue Execute(CellContext context, CellValue[] args)
    {
        ...
        try
        {
            ...
            var days = DayCountHelper.DaysBetween(previousCouponDate, settlement, basis);
