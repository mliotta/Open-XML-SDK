...
/// <summary>
/// Implements the IMSECH function.
/// IMSECH(inumber) - returns the hyperbolic secant of a complex number.
/// </summary>
public sealed class ImSechFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly ImSechFunction Instance = new();

    private ImSechFunction()
    {
    }
