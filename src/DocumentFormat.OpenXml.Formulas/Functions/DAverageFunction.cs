...
/// <summary>
/// Implements the DAVERAGE function.
/// DAVERAGE(database, field, criteria) - Average of values in field that meet criteria.
...
/// </summary>
public sealed class DAverageFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly DAverageFunction Instance = new();

    private DAverageFunction()
    {
    }

    /// <inheritdoc/>
    public string Name => "DAVERAGE";

    /// <inheritdoc/>
    public CellValue Execute(CellContext context, CellValue[] args)
    {
        // DAVERAGE requires exactly 3 arguments: database, field, criteria
        if (args.Length != 3)
        {
