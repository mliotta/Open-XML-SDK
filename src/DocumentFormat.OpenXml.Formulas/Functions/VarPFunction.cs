...
/// <summary>
/// Implements the VARP function.
/// VARP(number1, [number2], ...) - variance (population).
/// </summary>
public sealed class VarPFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly VarPFunction Instance = new();

    private VarPFunction()
    {
    }

    /// <inheritdoc/>
    public string Name => "VARP";
