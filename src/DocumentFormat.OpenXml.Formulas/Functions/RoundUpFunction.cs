...
/// <summary>
/// Implements the ROUNDUP function.
/// ROUNDUP(number, num_digits) - always rounds away from zero.
/// </summary>
public sealed class RoundUpFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly RoundUpFunction Instance = new();
