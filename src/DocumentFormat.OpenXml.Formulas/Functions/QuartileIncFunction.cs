...
/// <summary>
/// Implements the QUARTILE.INC function.
/// QUARTILE.INC(array, quart) - returns the quartile (0, 1, 2, 3, or 4).
/// Uses PERCENTILE.INC internally: 0=min, 1=25%, 2=50%, 3=75%, 4=max.
/// This is the same as the legacy QUARTILE function.
/// </summary>
public sealed class QuartileIncFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly QuartileIncFunction Instance = new();

    private QuartileIncFunction()
    {
    }
