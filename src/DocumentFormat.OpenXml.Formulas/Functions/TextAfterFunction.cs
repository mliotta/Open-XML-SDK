...
/// <summary>
/// Implements the TEXTAFTER function.
/// TEXTAFTER(text, delimiter, [instance_num], [match_mode], [match_end], [if_not_found]) - extracts text after delimiter.
/// </summary>
public sealed class TextAfterFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly TextAfterFunction Instance = new();

    private TextAfterFunction()
    {
    }
