...
/// <summary>
/// Implements the STDEVA function.
/// STDEVA(value1, [value2], ...) - Standard deviation (sample) including text and logical values.
/// Text evaluates as 0, TRUE as 1, FALSE as 0, empty values are ignored.
/// </summary>
public sealed class StDevAFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly StDevAFunction Instance = new();

    private StDevAFunction()
    {
    }

    /// <inheritdoc/>
    public string Name => "STDEVA";
