...
/// <summary>
/// Implements the DSTDEV function.
/// DSTDEV(database, field, criteria) - Sample standard deviation of values in field that meet criteria.
...
/// </summary>
public sealed class DStDevFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly DStDevFunction Instance = new();

    private DStDevFunction()
    {
    }

    /// <inheritdoc/>
    public string Name => "DSTDEV";

    /// <inheritdoc/>
    public FormulaResult Execute(CellContext context, FormulaResult[] args)
    {
        // DSTDEV requires exactly 3 arguments: database, field, criteria
        if (args.Length != 3)
        {
        ...
        // DSTDEV requires at least 2 values for sample standard deviation
        if (values.Count < 2)
        {
