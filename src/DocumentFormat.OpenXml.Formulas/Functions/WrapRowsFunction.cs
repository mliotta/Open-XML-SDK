...
/// <summary>
/// Implements the WRAPROWS function.
/// WRAPROWS(vector, wrap_count, [pad_with]) - Wraps a row or column of values into rows.
/// NOTE: Due to single-value return limitation, only the first element is returned.
/// </summary>
public sealed class WrapRowsFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly WrapRowsFunction Instance = new();

    private WrapRowsFunction()
    {
    }
    ...
    public CellValue Execute(CellContext context, CellValue[] args)
    {
        ...
        // In a full implementation, this would wrap values into rows
        return args[0];
    }
}
