...
/// <summary>
/// Implements the TOROW function.
/// TOROW(array, [ignore], [scan_by_column]) - Converts an array to a single row.
/// NOTE: Due to single-value return limitation, only the first element is returned.
/// </summary>
public sealed class ToRowFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly ToRowFunction Instance = new();

    private ToRowFunction()
    {
    }

    /// <inheritdoc/>
    public string Name => "TOROW";
