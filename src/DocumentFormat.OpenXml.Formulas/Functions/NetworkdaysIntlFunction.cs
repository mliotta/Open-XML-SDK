...
/// <summary>
/// Implements the NETWORKDAYS.INTL function.
/// NETWORKDAYS.INTL(start_date, end_date, [weekend], [holidays]) - returns the number of whole
/// working days between two dates, with customizable weekend days.
/// Weekend parameter can be a number (1-17) or a 7-character string of 0s and 1s.
/// </summary>
public sealed class NetworkdaysIntlFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly NetworkdaysIntlFunction Instance = new();

    private NetworkdaysIntlFunction()
    {
    }
    ...
    public CellValue Execute(CellContext context, CellValue[] args)
    {
        ...
        try
        {
            ...
            // If dates were reversed, return negative count
            if (reversed)
            {
