...
/// <summary>
/// Implements the COUPDAYSNC function.
...
/// </summary>
public sealed class CoupdaysncFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly CoupdaysncFunction Instance = new();
    ...
    public CellValue Execute(CellContext context, CellValue[] args)
    {
        ...
        try
        {
            ...
            var days = DayCountHelper.DaysBetween(settlement, nextCouponDate, basis);
