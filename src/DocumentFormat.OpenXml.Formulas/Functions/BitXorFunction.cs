...
/// <summary>
/// Implements the BITXOR function.
/// BITXOR(number1, number2) - returns a bitwise XOR of two numbers.
/// </summary>
public sealed class BitXorFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly BitXorFunction Instance = new();

    private BitXorFunction()
    {
    }
