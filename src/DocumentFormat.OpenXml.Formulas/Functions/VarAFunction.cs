...
/// <summary>
/// Implements the VARA function.
/// VARA(value1, [value2], ...) - Variance (sample) including text and logical values.
/// Text evaluates as 0, TRUE as 1, FALSE as 0, empty values are ignored.
/// </summary>
public sealed class VarAFunction : IFunctionImplementation
{
    /// <summary>
    /// Gets the singleton instance.
    /// </summary>
    public static readonly VarAFunction Instance = new();

    private VarAFunction()
    {
    }

    /// <inheritdoc/>
    public string Name => "VARA";
