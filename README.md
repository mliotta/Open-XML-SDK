...
- ✅ **173 built-in functions** (math, text, logical, lookup, date/time, statistical, financial, information, error handling)
...
## Supported Functions (173 total)

**Math (58)**: SUM, AVERAGE, COUNT, COUNTA, COUNTBLANK, MIN, MAX, ROUND, ROUNDUP, ROUNDDOWN, ABS, PRODUCT, POWER, MEDIAN, MODE, STDEV, VAR, SQRT, MOD, INT, CEILING, FLOOR, TRUNC, SIGN, EXP, LN, LOG, LOG10, PI, RADIANS, DEGREES, SIN, COS, TAN, SUMIFS, COUNTIFS, SUMPRODUCT, RAND, RANDBETWEEN, FACT, GCD, LCM, EVEN, ODD, ASIN, ACOS, ATAN, ATAN2, SINH, COSH, TANH, ASINH, ACOSH, ATANH, COMBIN, PERMUT, MROUND, QUOTIENT

**Text (27)**: CONCATENATE, LEFT, RIGHT, MID, LEN, TRIM, UPPER, LOWER, PROPER, FIND, SEARCH, SUBSTITUTE, TEXT, VALUE, REPLACE, REPT, EXACT, CHAR, CODE, CLEAN, T, CONCAT, TEXTJOIN, REVERSE, FIXED, DOLLAR, NUMBERVALUE
