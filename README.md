...
- ✅ **262 built-in functions** (math, text, logical, lookup, array, date/time, statistical, financial, engineering, database, information, error handling)
...
**Information (13)**: ISNUMBER, ISTEXT, ISEVEN, ISODD, ISLOGICAL, ISNONTEXT, ISREF, ISOMITTED, TYPE, ERROR.TYPE, N, CELL, INFO
