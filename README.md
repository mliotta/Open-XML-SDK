...
- ✅ **349 built-in functions** (math, text, logical, lookup, array, web, date/time, statistical, financial, engineering, database, information, error handling)
...
## Supported Functions (349 total)

**Math (76)**: SUM, AVERAGE, COUNT, COUNTA, COUNTBLANK, MIN, MAX, ROUND, ROUNDUP, ROUNDDOWN, ABS, PRODUCT, POWER, MEDIAN, MODE, STDEV, VAR, SQRT, MOD, INT, CEILING, FLOOR, TRUNC, SIGN, EXP, LN, LOG, LOG10, PI, RADIANS, DEGREES, SIN, COS, TAN, SUMIFS, COUNTIFS, SUMPRODUCT, RAND, RANDBETWEEN, RANDARRAY, FACT, GCD, LCM, EVEN, ODD, ASIN, ACOS, ATAN, ATAN2, ASINH, ACOSH, ATANH, SINH, COSH, TANH, ACOT, ACOTH, SEC, SECH, CSC, CSCH, COT, COTH, COMBIN, PERMUT, MROUND, QUOTIENT, SUMSQ, SUMX2MY2, SUMX2PY2, SUMXMY2, MULTINOMIAL, SERIESSUM, BASE, DECIMAL, ARABIC, ROMAN

**Text (44)**: CONCATENATE, LEFT, RIGHT, MID, LEN, TRIM, UPPER, LOWER, PROPER, FIND, SEARCH, SUBSTITUTE, TEXT, VALUE, REPLACE, REPT, EXACT, CHAR, CODE, CLEAN, T, CONCAT, TEXTJOIN, REVERSE, FIXED, DOLLAR, NUMBERVALUE, TRIMALL, UNICHAR, UNICODE, PHONETIC, TEXTBEFORE, TEXTAFTER, TEXTSPLIT, VALUETOTEXT, ARRAYTOTEXT, LENB, LEFTB, RIGHTB, MIDB, FINDB, SEARCHB, REPLACEB
...
**Statistical (78)**: SUMIF, COUNTIF, AVERAGEIF, STDEVP, VARP, LARGE, SMALL, PERCENTILE, QUARTILE, AVERAGEIFS, MAXIFS, MINIFS, CORREL, COVARIANCE.P, COVARIANCE.S, SLOPE, INTERCEPT, SKEW, KURT, FREQUENCY, PERCENTILE.INC, PERCENTILE.EXC, QUARTILE.INC, QUARTILE.EXC, FORECAST, FORECAST.LINEAR, TREND, GROWTH, LINEST, LOGEST, AVERAGEA, MINA, MAXA, STDEVA, STDEVPA, VARA, VARPA, SUBTOTAL, AGGREGATE, STDEV.S, STDEV.P, VAR.S, VAR.P, MODE.SNGL, MODE.MULT, NORM.DIST, NORM.INV, NORM.S.DIST, NORM.S.INV, CONFIDENCE, CONFIDENCE.NORM, CONFIDENCE.T, T.DIST, T.DIST.RT, T.DIST.2T, T.INV, T.INV.2T, TDIST, TINV, CHISQ.DIST, CHISQ.DIST.RT, CHISQ.INV, CHISQ.INV.RT, CHISQ.TEST, F.DIST, F.DIST.RT, F.INV, F.INV.RT, BETA.DIST, BETA.INV, LOGNORM.DIST, LOGNORM.INV

**Financial (21)**: PMT, FV, PV, NPER, RATE, NPV, IRR, XNPV, XIRR, IPMT, PPMT, CUMIPMT, CUMPRINC, MIRR, EFFECT, NOMINAL, FVSCHEDULE, SLN, DB, DDB, SYD

**Engineering (32)**: CONVERT, HEX2DEC, DEC2HEX, BIN2DEC, DEC2BIN, OCT2DEC, DEC2OCT, COMPLEX, IMREAL, IMAGINARY, IMABS, IMARGUMENT, IMCONJUGATE, IMSUM, IMSUB, IMPRODUCT, IMDIV, IMPOWER, IMSQRT, IMEXP, IMLN, IMLOG10, IMLOG2, IMSIN, IMCOS, IMTAN, IMSEC, IMCSC, IMCOT, IMSINH, IMCOSH, BITAND, BITOR, BITXOR, BITLSHIFT, BITRSHIFT

**Database (6)**: DSUM, DCOUNT, DCOUNTA, DAVERAGE, DMAX, DMIN

**Information (15)**: ISNUMBER, ISTEXT, ISEVEN, ISODD, ISLOGICAL, ISNONTEXT, ISREF, ISOMITTED, TYPE, ERROR.TYPE, N, NA, CELL, INFO, AREAS
