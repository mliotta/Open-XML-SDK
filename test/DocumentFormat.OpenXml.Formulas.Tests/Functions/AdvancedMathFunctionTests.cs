...
public class AdvancedMathFunctionTests
{
    ...
    public void SeriesSum_StandardCase_ReturnsCorrectValue()
    {
        ...
        var args = new[]
        {
            FormulaResult.FromNumber(2),  // x
            FormulaResult.FromNumber(0),  // n
            FormulaResult.FromNumber(1),  // m
            FormulaResult.FromNumber(1),  // coefficient
        };
    ...
    public void SeriesSum_WithPower_ReturnsCorrectValue()
    {
        ...
        {
            FormulaResult.FromNumber(2),  // x
            FormulaResult.FromNumber(2),  // n
            FormulaResult.FromNumber(1),  // m
            FormulaResult.FromNumber(3),  // coefficient
        };
    ...
    public void SeriesSum_NegativePower_ReturnsCorrectValue()
    {
        ...
        {
            FormulaResult.FromNumber(2),   // x
            FormulaResult.FromNumber(-1),  // n
            FormulaResult.FromNumber(1),   // m
            FormulaResult.FromNumber(4),   // coefficient
        };
    ...
    public void SeriesSum_ZeroBase_WithPositivePower_ReturnsZero()
    {
        ...
        var args = new[]
        {
            FormulaResult.FromNumber(0),  // x
            FormulaResult.FromNumber(2),  // n
            FormulaResult.FromNumber(1),  // m
            FormulaResult.FromNumber(5),  // coefficient
        };
